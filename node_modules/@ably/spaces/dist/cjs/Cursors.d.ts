...
import EventEmitter, { type EventListener } from './utilities/EventEmitter.js';
...
export default class Cursors extends EventEmitter<CursorsEventMap> {
    private space;
    private readonly cursorBatching;
    private readonly cursorDispensing;
    private readonly cursorHistory;
    /**
     ...
     */
    set(cursor: Pick<CursorUpdate, 'position' | 'data'>): Promise<void>;
    private getChannel;
    private initializeCursorsChannel;
    private onPresenceUpdate;
    private isUnsubscribed;
    private emitterHasListeners;
    /**
     * {@label WITH_EVENTS}
     *
     ...
     */
    subscribe<K extends keyof CursorsEventMap>(eventOrEvents: K | K[], listener?: EventListener<CursorsEventMap, K>): void;
    /**
     ...
     * @typeParam K A type which allows one or more names of the properties of the {@link CursorsEventMap} type.
     */
    unsubscribe<K extends keyof CursorsEventMap>(eventOrEvents: K | K[], listener?: EventListener<CursorsEventMap, K>): void;
    /**
     ...
     * <!-- END CLASS-DEFINITIONS DOCUMENTATION -->
     */
    getSelf(): Promise<CursorUpdate | null>;
    /**
     * <!-- This is to avoid duplication of the website documentation. -->
     * See the documentation for {@link getAll}.
     *
     ...
     * <!-- END CLASS-DEFINITIONS DOCUMENTATION -->
     */
    getOthers(): Promise<Record<string, null | CursorUpdate>>;
    /**
     ...
     * <!-- END CLASS-DEFINITIONS DOCUMENTATION -->
     */
    getAll(): Promise<Record<string, null | CursorUpdate>>;
}
