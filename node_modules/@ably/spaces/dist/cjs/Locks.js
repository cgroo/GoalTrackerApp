 ...
 */
class Locks extends EventEmitter_js_1.default {
    /** @internal */
    ...
    acquire(id, opts) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (lock && lock.status !== 'unlocked') {
                throw (0, Errors_js_1.ERR_LOCK_REQUEST_EXISTS)();
            }
    ...
    release(id) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!lock)
                return;
            this.setLock(Object.assign(Object.assign({}, lock), { status: 'unlocked', reason: undefined }));
    ...
    subscribe(listenerOrEvents, listener) {
        try {
            ...
            if (e instanceof EventEmitter_js_1.InvalidArgumentError) {
                throw new EventEmitter_js_1.InvalidArgumentError('Locks.subscribe(): Invalid arguments: ' + (0, EventEmitter_js_1.inspect)([listenerOrEvents, listener]));
            }
            else {
                throw e;
            }
    ...
    unsubscribe(listenerOrEvents, listener) {
        try {
            ...
            if (e instanceof EventEmitter_js_1.InvalidArgumentError) {
                throw new EventEmitter_js_1.InvalidArgumentError('Locks.unsubscribe(): Invalid arguments: ' + (0, EventEmitter_js_1.inspect)([listenerOrEvents, listener]));
            }
            else {
                throw e;
            }
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (message.action === 'leave' || !Array.isArray((_a = message === null || message === void 0 ? void 0 : message.extras) === null || _a === void 0 ? void 0 : _a.locks)) {
                ...
                for (const locks of this.locks.values()) {
                    ...
                    if (lock) {
                        const updatedLock = Object.assign(Object.assign({}, lock), { status: 'unlocked', reason: undefined });
            ...
            message.extras.locks.forEach((lock) => {
                ...
                if (!existing || existing.status !== lock.status) {
                    this.emit('update', Object.assign(Object.assign({}, lock), { member }));
                }
                // TODO this lock that comes from the PresenceMessage has no type checking
                this.setLock(Object.assign(Object.assign({}, lock), { member }));
            });
    ...
    processPending(member, pendingLock) {
        ...
        // the LOCKED request.
        if (pendingLock.timestamp < lock.timestamp ||
            (pendingLock.timestamp == lock.timestamp && member.connectionId < lock.member.connectionId)) {
            pendingLock.status = 'locked';
            const updatedLock = Object.assign(Object.assign({}, lock), { status: 'unlocked', reason: (0, Errors_js_1.ERR_LOCK_INVALIDATED)() });
            this.setLock(updatedLock);
            this.emit('update', updatedLock);
            return;
        }
        ...
        pendingLock.reason = (0, Errors_js_1.ERR_LOCK_IS_LOCKED)();
    }
    updatePresence(self) {
        const update = new SpaceUpdate_js_1.default({ self, extras: this.getLockExtras(self.connectionId) });
