...
const Leavers_js_1 = __importDefault(require("./Leavers.js"));
/**
 ...
 */
class Members extends EventEmitter_js_1.default {
    /** @internal */
    constructor(space) {
        super();
        this.space = space;
        this.lastMemberUpdate = {};
        this.leavers = new Leavers_js_1.default(this.space.options.offlineTimeout);
    }
    /** @internal */
    ...
    subscribe(listenerOrEvents, listener) {
        try {
            ...
            if (e instanceof EventEmitter_js_1.InvalidArgumentError) {
                throw new EventEmitter_js_1.InvalidArgumentError('Members.subscribe(): Invalid arguments: ' + (0, EventEmitter_js_1.inspect)([listenerOrEvents, listener]));
            }
            else {
                throw e;
            }
    ...
    unsubscribe(listenerOrEvents, listener) {
        try {
            ...
            if (e instanceof EventEmitter_js_1.InvalidArgumentError) {
                throw new EventEmitter_js_1.InvalidArgumentError('Members.unsubscribe(): Invalid arguments: ' + (0, EventEmitter_js_1.inspect)([listenerOrEvents, listener]));
            }
            else {
                throw e;
            }
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (member.location) {
                this.space.locations.emit('update', {
                    ...
                    member: Object.assign(Object.assign({}, member), { location: null }),
                });
            }
            this.space.emit('update', { members: yield this.getAll() });
        });
    }
}
