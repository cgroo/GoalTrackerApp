 ...
 */
declare class Space extends EventEmitter<SpaceEventMap> {
    /**
     * @internal
     */
    ...
    private presenceEnter;
    private presenceLeave;
    private setOptions;
     ...
     */
    enter(profileData?: ProfileData): Promise<SpaceMember[]>;
    /**
     * {@label MAIN_OVERLOAD}
     *
     ...
     */
    updateProfileData(updateFn: UpdateProfileDataFunction): Promise<void>;
    /**
     ...
     */
    leave(profileData?: ProfileData): Promise<void>;
    /**
