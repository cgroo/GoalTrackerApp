...
const Space_js_1 = __importDefault(require("./Space.js"));
    ...
    get(name, options) {
        return __awaiter(this, void 0, void 0, function* () {
            if (typeof name !== 'string' || name.length === 0) {
                throw (0, Errors_js_1.ERR_SPACE_NAME_MISSING)();
            }
            ...
            const space = new Space_js_1.default(name, this.client, options);
