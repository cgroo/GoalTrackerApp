 ...
 */
export declare namespace LocationsEvents {
    /**
...
export default class Locations extends EventEmitter<LocationsEventMap> {
    ...
    private lastLocationUpdate;
    /** @internal */
    constructor(space: Space, presenceUpdate: Space['presenceUpdate']);
    /** @internal */
    processPresenceMessage(message: PresenceMember): Promise<void>;
    /**
     ...
     */
    set(location: unknown): Promise<void>;
    /**
     * {@label WITH_EVENTS}
     *
     ...
     */
    subscribe<K extends keyof LocationsEventMap>(eventOrEvents: K | K[], listener?: EventListener<LocationsEventMap, K>): void;
    /**
     ...
     * @typeParam K A type which allows one or more names of the properties of the {@link LocationsEventMap} type.
     */
    unsubscribe<K extends keyof LocationsEventMap>(eventOrEvents: K | K[], listener?: EventListener<LocationsEventMap, K>): void;
    /**
     ...
     * <!-- END CLASS-DEFINITIONS DOCUMENTATION -->
     */
    getOthers(): Promise<Record<string, unknown>>;
    /**
