...
export default class Locks extends EventEmitter<LocksEventMap> {
     ...
     */
    acquire(id: string, opts?: LockOptions): Promise<Lock>;
    /**
    ...
    /** @internal */
    processPresenceMessage(message: Types.PresenceMessage): Promise<void>;
    ...
    private setLock;
    private deleteLock;
    private getLocksForConnectionId;
    /** @internal */
