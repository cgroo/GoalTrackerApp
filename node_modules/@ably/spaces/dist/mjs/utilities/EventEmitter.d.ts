 ...
 */
export declare function removeListener<T>(targetListeners: (Function[] | Record<keyof T, Function[]>)[], listener: Function, eventFilter?: keyof T): void;
export declare function inspect(args: unknown): string;
...
export default class EventEmitter<T> {
     ...
     * We add the implementation signature as an overload signature (but mark it as internal so that it does not appear in documentation) so that it can be called by subclasses.
     */
    once<K extends keyof T>(listenerOrEvent: K | EventListener<T, K>, listener?: EventListener<T, K>): void | Promise<any>;
    /**
     * @internal
     *
     ...
     */
    whenState<K extends keyof T>(targetState: K, currentState: keyof T, listener: EventListener<T, K>, listenerArg: T[K]): Promise<unknown> | undefined;
}
